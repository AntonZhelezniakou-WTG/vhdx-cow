...
/// <summary>
/// Convenience wrapper for invoking <c>vhdx.exe</c> in the guest. Uses the
...
/// </summary>
public static class Vhdx
{
	public const string ExePath = @"C:\Program Files\VhdxManager\Cli\vhdx.exe";
