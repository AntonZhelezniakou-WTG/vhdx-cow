...
/// <item><c>vhmgr create --parent</c> a managed <em>child</em> from the parent — represents
///   a worker that will be recreated after the publish.</item>
/// <item><c>vhmgr create --parent</c> an <em>overlay</em> from the same parent — this is
