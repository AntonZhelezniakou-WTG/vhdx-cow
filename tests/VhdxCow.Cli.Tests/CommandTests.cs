...
namespace VhdxCow.Cli.Tests;

[TestFixture]
public class CommandTests
{
	IVhdxCowClient mockClient = null!;
	...
	public void SetUp()
	{
		mockClient = Substitute.For<IVhdxCowClient>();
	...
	{
		mockClient.PingAsync(Arg.Any<CancellationToken>())
			.Returns<PingReply>(_ => throw new VhdxCowServiceException("service down"));
	...
	[Test]
	public async Task PipeName_DefaultsToVhdxCowService()
	{
		mockClient.PingAsync(Arg.Any<CancellationToken>())
